...
pub fn file_pdf(size: usize) -> Html {
    // https://icons.getbootstrap.com/icons/file-pdf/
    html!(
        <svg xmlns="http://www.w3.org/2000/svg" width={size.to_string()} height={size.to_string()} fill="currentColor" class="bi bi-file-pdf" viewBox="0 0 16 16">
